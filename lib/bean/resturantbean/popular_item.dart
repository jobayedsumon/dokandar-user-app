class PopularItem {
  ...
  factory PopularItem.fromJson(dynamic json) {
    ...
    if (tagObjsJson != null) {
      _tags = tagObjsJson
          .map((tagJson) => PopularItemListd.fromJson(tagJson))
          .toList();
    }
...
class AddOnList {
  ...
  factory AddOnList.fromJson(dynamic json) {
    return AddOnList(json['addon_id'], json['addon_name'], json['addon_price'],
        json['product_id'], json['vendor_id'], false);
  }
}
