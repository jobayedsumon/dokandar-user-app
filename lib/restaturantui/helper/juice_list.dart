                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            ...
                            top: fixPadding),
                        child: Text(
                          '(${widget.categoryListNew[index].variant.length != 0 ? widget.categoryListNew[index].variant[0].quantity : ''} '
                          '${widget.categoryListNew[index].variant.length != 0 ? widget.categoryListNew[index].variant[0].unit : ''})',
                          style: listItemSubTitleStyle,
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                        ),
                      ...
                      Padding(
                        padding:
                            EdgeInsets.only(top: fixPadding, left: fixPadding),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: <Widget>[
                            Text(
                              '${widget.currencySymbol ?? '৳'} ${widget.categoryListNew[index].variant.length != 0 ? widget.categoryListNew[index].variant[0].price : ''}',
                              // '',
                              style: priceStyle,
                            ),
                            InkWell(
                              onTap: () async {
                                ...
                                db
                                  ...
                                  if (value != null) {
                                    ...
                                    if (widget.categoryListNew[index].variant[0]
                                            .addOnQty >
                                        0) {
                                      setState(() {
                                        widget.categoryListNew[index].variant[0]
