                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: () {
                                ...
                                if ((nearStores[index].online_status == "on" ||
                                    nearStores[index].online_status == "On" ||
                                    nearStores[index].online_status == "ON")) {
                                  hitNavigator(context, nearStores[index]);
                                } else {
                                  Toast.show(
                                      'Restaurant are closed now!', context,
                                      duration: Toast.LENGTH_SHORT);
                                }
                              },
                                            ...
                                            children: <Widget>[
                                              ...
                                              Row(
                                                children: <Widget>[
                                                  ...
                                                  SizedBox(width: 10.0),
                                                  Text(
                                                      '${double.parse('${nearStores[index].distance ?? 0}').toStringAsFixed(2)} km ',
                                                      style: Theme.of(context)
                                                          .textTheme
                                                          .caption
                                                          .copyWith(
                                              ...
                                              Row(
                                                children: <Widget>[
                                                  ...
                                                  SizedBox(width: 10.0),
                                                  Text(
                                                      '${calculateTime(double.parse('${nearStores[index].lat ?? 0}'), double.parse('${nearStores[index].lng ?? 0}'), userLat, userLng)}',
                                                      style: Theme.of(context)
                                                          .textTheme
                                                          .caption
                                                          .copyWith(
