...
class PharmaItemPage extends StatefulWidget {
  ...
  PharmaItemPage(
      this.vendorName, this.vendorId, this.deliveryRange, this.distance);
...
class _ItemsPharmaPageState extends State<PharmaItemPage>
  ...
  void hitPharmacyItem() async {
    ...
    http.post(url, body: {'vendor_id': '${widget.vendorId}'}).then((response) {
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            SizedBox(width: 10.0),
                            Text(
                                '${double.parse('${widget.distance ?? 0}').toStringAsFixed(2)} km ',
...
//                                scale: 2.5,
                                                                      ...
                                                                      if (value !=
                                                                        ...
                                                                        var vae =
                                                                          ...
                                                                          DatabaseHelper.addonid:
                                                                              '${categoryList3[index].addons[i].addon_id}',
                                                                          DatabaseHelper.price: categoryList3[index]
                                                                              .addons[i]
                                                                              .addon_price,
                                                                          DatabaseHelper.addonName: categoryList3[index]
                                                                              .addons[i]
                                                                              .addon_name
                                                                        };
                    ...
                    Container(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          print("VENDOR ID WIDGET: ${widget.vendorId}");
                          Navigator.of(context)
                              .push(MaterialPageRoute(builder: (context) {
                            return UploadPrescription(widget.vendorId);
                          }));
                        },
                        behavior: HitTestBehavior.opaque,
                        child: Material(
