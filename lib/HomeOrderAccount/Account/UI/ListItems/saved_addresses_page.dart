...
//    _addressBlocf.add(FetchAddressesEvent());
  ...
  void getVendorAddress(BuildContext context) async {
    print("INSIDE GET VENDOR ADDDRESS");
    ...
    print('GET VEDNOR ADDRESS: ${vendorId} - ${userId}');
                                            ...
                                            Positioned(
                                              ...
                                              child: Visibility(
                                                ...
                                                child: Container(
                                                  ...
                                                  color: kCardBackgroundColor,
                                                  child: Text(
                                                    'We are not delivering in this address',
                                                    style:
  ...
  void selectAddressd(dynamic value, vendorId) async {
    ...
    http.post(url, body: {'address_id': '${value}'}).then((value) {
      ...
      if (value.statusCode == 200) {
        ...
        Toast.show('Unable to select address', context,
            duration: Toast.LENGTH_SHORT);
        setState(() {
          showDialogBox = false;
        });
